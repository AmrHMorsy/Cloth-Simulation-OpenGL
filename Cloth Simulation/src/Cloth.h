...
public:
    ...
    Cloth( glm::mat4 view, glm::mat4 projection, glm::vec3 c, glm::vec3 front, float fv, progressbar * b, glm::mat4 lightproj, glm::mat4 lightview ) ;
    void set( Skybox * skybox, Collision_Detector * collision_detector ) ;
