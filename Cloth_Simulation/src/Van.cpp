...
Van::Van( glm::mat4 v, glm::mat4 proj, glm::vec3 c, glm::vec3 front, float fv, progressbar * b ): num_progress_bars(10),light_position({0.484394f, 7.5f, 0.416144f}), light_color({10.0f, 10.0f, 10.0f}), view(v), projection(proj), camera(c), file_paths( {"../assets/Van/Body/Albedo.png", "../assets/Van/Body/AO.jpg", "../assets/Van/Body/Normal.png", "../assets/Van/Body/Roughness.png", "../assets/Van/Body/Displacement.png", "../assets/Van/Body/Metallic.png"} ), camera_front(front), fov(fv), number_sand_patches(0), bar(b)
{
