...
public:
    ...
    Cloth( glm::mat4 v, glm::mat4 proj, glm::vec3 c, progressbar * b, std::vector<std::string> texture_paths, std::string file_path, glm::mat4 lightproj, glm::mat4 lightview ) ;
    std::vector<float> get_v() ;
    void activate_cloth(std::string file_path, std::vector<float> c) ;
    void compute_fixed_points(std::string file_path) ;
    ...
    void update_light( glm::vec3 position, glm::mat4 proj, glm::mat4 view ) ;
    ...
    void update_light_intensity( glm::vec3 col ) ;
    ~Cloth() ;
...
Cloth::Cloth( glm::mat4 v, glm::mat4 proj, glm::vec3 c, progressbar * b, glm::mat4 lightproj, glm::mat4 lightview ) ;
