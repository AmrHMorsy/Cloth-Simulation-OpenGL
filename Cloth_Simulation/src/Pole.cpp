...
Pole::Pole( glm::mat4 v, glm::mat4 proj, glm::vec3 c, glm::vec3 front, float fv, progressbar * b ): num_progress_bars(10),light_position({0.484394f, 7.5f, 0.416144f}), light_color({10.0f, 10.0f, 10.0f}), view(v), projection(proj), camera(c), file_paths( {"../assets/Pole/Albedo.png", "../assets/Pole/AO.png", "../assets/Pole/Normal.png", "../assets/Pole/Roughness.png", "../assets/Pole/Displacement.png", "../assets/Pole/Metallic.png"} ), camera_front(front), fov(fv), number_sand_patches(0), bar(b)
{
    ...
    model = glm::translate(glm::mat4(1.0f),glm::vec3(0.0f,0.7f,2.0f)) * glm::rotate(glm::mat4(1.0f),glm::radians(180.0f),glm::vec3(0.0f,1.0f,0.0f)) * glm::scale(glm::mat4(1.0f), glm::vec3(0.1f, 0.15f, 0.1f)) ;
    model2 = glm::translate(glm::mat4(1.0f),glm::vec3(2.0f,0.7f,7.45058e-08)) * glm::rotate(glm::mat4(1.0f),glm::radians(180.0f),glm::vec3(0.0f,1.0f,0.0f)) * glm::scale(glm::mat4(1.0f), glm::vec3(0.1f, 0.15f, 0.1f)) ;
...
void Pole::shade( unsigned int shadow_shader_program )
{
    ...
    glBindVertexArray(0) ;
    glBindVertexArray(vao) ;
    glUniformMatrix4fv(glGetUniformLocation(shadow_shader_program, "model"), 1, GL_FALSE, &model2[0][0]) ;
    glDrawElements(GL_TRIANGLES, number_of_indices, GL_UNSIGNED_INT, 0 ) ;
    glBindVertexArray(0) ;
}
