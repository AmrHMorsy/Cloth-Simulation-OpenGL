...
Bag::Bag( glm::mat4 v, glm::mat4 proj, glm::vec3 c, glm::vec3 front, float fv, progressbar * b ): num_progress_bars(10),light_position({0.484394f, 7.5f, 0.416144f}), light_color({10.0f, 10.0f, 10.0f}), view(v), projection(proj), camera(c), file_paths( {"../assets/Bag/Albedo.png", "../assets/Bag/AO.png", "../assets/Bag/Normal.png", "../assets/Bag/Roughness.png", "../assets/Bag/Displacement.png", "../assets/Bag/Metallic.png"} ), camera_front(front), fov(fv), number_sand_patches(0), bar(b)
{
    ...
    model = glm::translate(glm::mat4(1.0f), glm::vec3(-2.5f, 1.25f, -0.4f)) * glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f,1.0f,0.0f)) * glm::rotate(glm::mat4(1.0f), glm::radians(-5.0f), glm::vec3(0.0f,0.0f,1.0f))* glm::scale(glm::mat4(1.0f), glm::vec3(0.2f, 0.2f, 0.2f)) ;
