...
private:
    ...
    glm::mat4 models[NUMBER_SAND_PATCHES], projection, view,  light_projection, light_view ;
...
public:
    ...
    Grass( glm::mat4 view, glm::mat4 projection, glm::vec3 c, glm::vec3 front, float fv, progressbar * b, glm::mat4 lightproj, glm::mat4 lightview ) ;
