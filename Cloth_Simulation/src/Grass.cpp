...
Grass::Grass( glm::mat4 v, glm::mat4 proj, glm::vec3 c, glm::vec3 front, float fv, progressbar * b, glm::mat4 lightproj, glm::mat4 lightview ): num_progress_bars(10),light_position({0.484394f, 7.5f, 0.416144f}), light_color({100.0f, 100.0f, 100.0f}), view(v), projection(proj), camera(c), file_paths( {"../assets/Ground/Albedo.png", "../assets/Ground/AO.png", "../assets/Ground/Normal.png", "../assets/Ground/Roughness.png", "../assets/Ground/Displacement.png", "../assets/Ground/Metallic.png" } ), camera_front(front), fov(fv), number_sand_patches(0), bar(b), light_projection(lightproj), light_view(lightview)
{
