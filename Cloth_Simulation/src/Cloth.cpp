...
Cloth::Cloth( glm::mat4 v, glm::mat4 proj, glm::vec3 c, glm::vec3 front, float fv, progressbar * b, glm::mat4 lightproj, glm::mat4 lightview ): num_progress_bars(10),light_position({0.484394f, 7.5f, 0.416144f}), light_color({10.0f, 10.0f, 10.0f}), view(v), projection(proj), camera(c), file_paths( {"../assets/Cloth/Albedo.jpg", "../assets/Cloth/AO.jpg", "../assets/Cloth/Normal.png", "../assets/Cloth/Roughness.jpg", "../assets/Cloth/Displacement.png", "../assets/Cloth/Metallic.png"} ), camera_front(front), fov(fv), number_sand_patches(0), bar(b), simulate(false), light_projection(lightproj), light_view(lightview)
{
    ...
    model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f,2.2f,0.0f)) * glm::scale( glm::mat4(1.0f), glm::vec3(1.0f,1.0f,1.0f) ) ;
